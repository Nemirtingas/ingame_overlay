...
bool VulkanHook_t::_CreateDescriptorPool()
{
...
bool VulkanHook_t::_CreateRenderTargets(VkImage* backBuffers, uint32_t backBufferCount)
{
...
bool VulkanHook_t::_SetupVulkanRenderer(VkSwapchainKHR swapChain)
{
...
{
    if (!_Initialized || !ImGui_ImplVulkan_NewFrame() || !WindowsHook_t::Inst()->PrepareForOverlay(_MainWindow))
        return nullptr;
