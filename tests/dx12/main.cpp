...
static bool                         g_usePresent1 = true;
...
int main(int, char**)
{
    ...
    while (!done)
    {
        ...
        ImGui_ImplDX12_RenderDrawData(ImGui::GetDrawData(), g_pd3dCommandList, &g_pd3dSrvDescHeap, 1, 1);
        ...
        if (g_usePresent1)
        {
            ...
            g_pSwapChain->Present1(1, 0, &present_parameters);
        }
        else
        {
